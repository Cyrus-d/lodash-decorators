 ...
 */
exports.MemoizeAll = factory_1.DecoratorFactory.createDecorator(new factory_1.DecoratorConfig(lodash_es_1.memoize, new applicators_1.MemoizeApplicator(), { optionalParams: true }));
