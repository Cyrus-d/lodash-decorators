...
var decorator = factory_1.DecoratorFactory.createInstanceDecorator(new factory_1.DecoratorConfig(lodash_es_1.flip, new applicators_1.PartialValueApplicator(), { property: true }));
/**
