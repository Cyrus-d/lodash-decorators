...
var decorator = factory_1.DecoratorFactory.createDecorator(new factory_1.DecoratorConfig(lodash_es_1.after, new applicators_1.PostValueApplicator(), { setter: true }));
/**
