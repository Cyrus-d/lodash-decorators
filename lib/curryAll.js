 ...
 */
exports.CurryAll = factory_1.DecoratorFactory.createDecorator(new factory_1.DecoratorConfig(lodash_es_1.curry, new applicators_1.PreValueApplicator(), { optionalParams: true }));
